...
console.log(validateName(n1));
console.log(validateName(n2));
console.log(validateName(n3));


//     - створити функцію, яка генерує масив рандомних числових цілих значень в діапазоні від 0 до 100.
// let generationRandom = (limit, n) =>{
//     let arr = [];
//     for (let i = 0; i < n; i++) {
...
//     return arr;
// };
// console.log(generationRandom(100,14));
...
let generationRandom = (limit, n) => {
    ...
    ;
    let filterArr = arr.filter((arr, (index) => index % 2 === 0))
    return filterArr;
};
console.log(generationRandom(100, 14));
...
let sortArr = (arr) => {
    for (const arrElement of arr) {
        for (const key in arrElement) {
            let courseSort = arr.sort((a, b) => b.modules.length - a.modules.length);
            return courseSort;
        }
        ;
    }
...
let cutString2 = (str, n) => {
    let newString = str.split(' ').slice(0, n).join(' ');
    return newString;
};
